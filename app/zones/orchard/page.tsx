    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 pb-10">
        ...
        <div className="mx-4 mt-6 grid grid-cols-2 gap-3">
          {/* Health Score card */}
          <div className="rounded-2xl p-4 flex flex-col items-center" style={{ backgroundColor: "rgba(19,28,46,0.78)" }}>
            <span className="text-[#9CA3AF] text-xs mb-2">Health Score</span>
            <svg width="100" height="100" viewBox="0 0 100 100">
              <circle cx="50" cy="50" r={radius} fill="none" stroke="rgba(28,42,64,0.6)" strokeWidth="7" />
              <circle
                cx="50"
                cy="50"
                r={radius}
          ...
          <div className="rounded-2xl p-4 flex flex-col justify-center" style={{ backgroundColor: "rgba(19,28,46,0.78)" }}>
        ...
        {/* Next Harvest card */}
        <div className="mx-4 mt-3 rounded-2xl p-4 flex justify-between items-center" style={{ backgroundColor: "rgba(19,28,46,0.78)" }}>
          <div>
        ...
        <div className="mx-4 mt-3 grid grid-cols-2 gap-3">
          <div className="rounded-2xl p-4" style={{ backgroundColor: "rgba(19,28,46,0.78)" }}>
        ...
        {/* Disease Risk card */}
        <div className="mx-4 mt-3 mb-8 rounded-2xl p-4 flex justify-between items-center" style={{ backgroundColor: "rgba(19,28,46,0.78)" }}>
